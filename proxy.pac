// Proxy Auto-Config file generated by autoproxy2pac, 2014-10-20 09:04:10
function FindProxyForURL(url, host) {
    ...
    if (isPlainHostName(host) ||
        ...
        return FindProxyForURLByMe(url, host);
    }
}
...
function FindProxyForURLByMe(url, host) {
    var lastPos;
    do {
        if (my_proxy_host.hasOwnProperty(host)) {
